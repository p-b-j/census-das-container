...
python_cmd="checkInvariantsNotImposed.py"
echo
echo
...
nohup 2>&1 $spark_submit --conf "spark.executor.extraJavaOptions=$extra_java_options" $python_cmd &> checkInvariantsNotImposed.out &
