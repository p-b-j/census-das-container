...
samplerate = 0.0001
#output_path = f"{das_s3root}/title13_input_data/test"
output_path = f"{das_s3root}/{username}/testdata"

dfp = spark.read.csv(f'{das_s3root}/title13_input_data/table1a/ri44.txt', sep='\t', header=True)
dfu = spark.read.csv(f'{das_s3root}/title13_input_data/table10/ri44.txt', sep='\t', header=True)
...
dfh = spark.read.csv(f'{das_s3root}/title13_input_data/table12a/ri44.txt', sep='\t', header=True)
dfu = spark.read.csv(f'{das_s3root}/title13_input_data/table10_20190610/ri44.txt', sep='\t', header=True)
...
dfp = spark.read.csv(f'{das_s3root}/title13_input_data/table13/ri44.txt', sep='\t', header=True)
dfu = spark.read.csv(f'{das_s3root}/title13_input_data/table10_20190610/ri44.txt', sep='\t', header=True)
