...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/spark/spark-2.4.7-bin-hadoop2.7/bin:/usr/local/spark/spark-2.4.7-bin-hadoop2.7/sbin:/usr/local/anaconda3/bin:/usr/local/gurobi911/linux64/bin:/usr/local/gurobi911/linux64/bin:/usr/local/anaconda3/bin"
