...
class DHCH_Household_recoder:
    ...
    def __init__(
            ...
            hhhisp_varname_list,
            hhrace_varname_list,
            elderly_varname_list,
            tenshort_varname_list,
            hht_varname_list
    ):
        ...
        self.tenshort_varname_list: Tuple[str] = tenshort_varname_list
    ...
    def recode(self, row):
        ...
        try:
            ...
            ten: str = str(row[self.tenshort_varname_list[0]])
            ...
            row_dict[CC.ATTR_HHTENSHORT] = tenshort_recode(ten)
...
def size_recode(final_pop: str):
    ...
    assert 0 < int(final_pop) <= 97, f'FINAL_POP is illegal value {final_pop}, should be between 0 and 97, refer CEF spec CEF20_UNIT'
    return min(int(final_pop), 7)

def child_under_18_recode(p18: int):
    assert 0 <= p18 <= 97, f'P18 is illegal value {p18}, should be between 0 and 97, refer CEF spec CEF20_Unit'
    return min(p18, 1)
...
class DHCH_Unit_recoder:
    ...
    """
    def __init__(self, tenvacgq_list):
