...
[[ -v SPARK_RESOURCES ]] ||
  SPARK_RESOURCES="--driver-memory 10g --num-executors 20 --executor-memory 120g --executor-cores 12 --driver-cores 10 --conf spark.dynamicAllocation.maxExecutors=20 --conf spark.driver.maxResultSize=0g --conf spark.executor.memoryOverhead=100g"
