...
def main():
    ...
    # Example:
    # fiery-ITE-MASTER:hadoop@ip-10-252-46-90$ aws s3 ls s3://uscb-decennial-ite-das/users/lecle301/cnstatDdpSchema_SinglePassRegular_nat_H1_Only_withMeasurements_v8/noisy_measurements-eps0.5-run1/
    ...
    for index, geolevel in enumerate(geolevels):
        ...
        eps = "0.5"
        run = "1"
        base_path = "s3://uscb-decennial-ite-das/users/lecle301/cnstatDdpSchema_SinglePassRegular_nat_H1_Only_withMeasurements_v8/"
