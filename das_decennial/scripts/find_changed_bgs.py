...
orig_spine, orig_spine_rdd, orig_spine_df = collect_spine_info('s3://uscb-decennial-ite-das/users/cumin002/spine_from_ppmf05042021.csv')
alt_spine, alt_spine_rdd, alt_spine_df = collect_spine_info('s3://uscb-decennial-ite-das/users/cumin002/spine_isolating_aians_in_bg05042021.csv')
