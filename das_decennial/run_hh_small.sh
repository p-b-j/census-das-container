...
[[ -v SPARK_RESOURCES ]] ||
  SPARK_RESOURCES="--driver-memory 5g --num-executors 16 --executor-memory 100g --executor-cores 24 --driver-cores 10 --conf spark.dynamicAllocation.maxExecutors=16 --conf spark.driver.maxResultSize=0g --conf spark.executor.memoryOverhead=100g"
