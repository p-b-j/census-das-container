...
# Automatically generated on Fri Oct 30 14:06:06 2020 by /mnt/users/will0555/new-das-vm/das-vm-config/das_decennial/das_framework/ctools/schema/table.py
...
class E_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_ABRAF(fields[1]) == False: return False
        if self.is_valid_ACOCE(fields[2]) == False: return False
        if self.is_valid_BCUCOUNTYFP(fields[3]) == False: return False
        if self.is_valid_BCUID(fields[4]) == False: return False
        if self.is_valid_BCUSTATEFP(fields[5]) == False: return False
        if self.is_valid_BCUTRACTCE(fields[6]) == False: return False
        if self.is_valid_CARRETERA(fields[7]) == False: return False
        if self.is_valid_CENSTAT2010(fields[8]) == False: return False
        if self.is_valid_CENSTAT2020(fields[9]) == False: return False
        if self.is_valid_CENSURV(fields[10]) == False: return False
        if self.is_valid_CENSUS2010(fields[11]) == False: return False
        if self.is_valid_CENSUS2020(fields[12]) == False: return False
        if self.is_valid_CENSUSAF(fields[13]) == False: return False
        if self.is_valid_CFUFVAF(fields[14]) == False: return False
        if self.is_valid_COLLAF(fields[15]) == False: return False
        if self.is_valid_COLLUNV(fields[16]) == False: return False
        if self.is_valid_COMPLETELOCNAME(fields[17]) == False: return False
        if self.is_valid_COMPLETEMAILNAME(fields[18]) == False: return False
        if self.is_valid_CONTITLE(fields[19]) == False: return False
        if self.is_valid_COORDTYP(fields[20]) == False: return False
        if self.is_valid_CURBLK(fields[21]) == False: return False
        if self.is_valid_CURBLKCOU(fields[22]) == False: return False
        if self.is_valid_CURBLKST(fields[23]) == False: return False
        if self.is_valid_CURBLKSUFX1(fields[24]) == False: return False
        if self.is_valid_CURBLKSUFX2(fields[25]) == False: return False
        if self.is_valid_CURBLKTRACT(fields[26]) == False: return False
        if self.is_valid_CURCOUNTY(fields[27]) == False: return False
        if self.is_valid_CURSTATE(fields[28]) == False: return False
        if self.is_valid_DELPTTYPE(fields[29]) == False: return False
        if self.is_valid_DSAF(fields[30]) == False: return False
        if self.is_valid_DSFBASEALT(fields[31]) == False: return False
        if self.is_valid_DSFFALLAST(fields[32]) == False: return False
        if self.is_valid_DSFRT(fields[33]) == False: return False
        if self.is_valid_DSFSPRLAST(fields[34]) == False: return False
        if self.is_valid_ENUMAF(fields[35]) == False: return False
        if self.is_valid_ENUMAF2010(fields[36]) == False: return False
        if self.is_valid_ENUMUNV(fields[37]) == False: return False
        if self.is_valid_FACTLNAME(fields[38]) == False: return False
        if self.is_valid_GQAREACODE(fields[39]) == False: return False
        if self.is_valid_GQCONTACT(fields[40]) == False: return False
        if self.is_valid_GQCURRMAXPOP(fields[41]) == False: return False
        if self.is_valid_GQCURRSIZE(fields[42]) == False: return False
        if self.is_valid_GQEXT(fields[43]) == False: return False
        if self.is_valid_GQHUFLAG(fields[44]) == False: return False
        if self.is_valid_GQID(fields[45]) == False: return False
        if self.is_valid_GQNAME(fields[46]) == False: return False
        if self.is_valid_GQPHONE(fields[47]) == False: return False
        if self.is_valid_GQTYPCUR(fields[48]) == False: return False
        if self.is_valid_HUTYP(fields[49]) == False: return False
        if self.is_valid_INITUCMAF(fields[50]) == False: return False
        if self.is_valid_INSITE(fields[51]) == False: return False
        if self.is_valid_IOACIRAF(fields[52]) == False: return False
        if self.is_valid_IS2020DLV(fields[53]) == False: return False
        if self.is_valid_ISOLQ(fields[54]) == False: return False
        if self.is_valid_ISUCMDLV(fields[55]) == False: return False
        if self.is_valid_KMHM(fields[56]) == False: return False
        if self.is_valid_LEGACYMAFID(fields[57]) == False: return False
        if self.is_valid_LIMADEL(fields[58]) == False: return False
        if self.is_valid_LOCAPTCOMPLEX(fields[59]) == False: return False
        if self.is_valid_LOCAREANM1(fields[60]) == False: return False
        if self.is_valid_LOCAREANM2(fields[61]) == False: return False
        if self.is_valid_LOCBLDGDESC(fields[62]) == False: return False
        if self.is_valid_LOCBLDGID(fields[63]) == False: return False
        if self.is_valid_LOCDESC(fields[64]) == False: return False
        if self.is_valid_LOCHN1(fields[65]) == False: return False
        if self.is_valid_LOCHN2(fields[66]) == False: return False
        if self.is_valid_LOCHNPR(fields[67]) == False: return False
        if self.is_valid_LOCHNPRE(fields[68]) == False: return False
        if self.is_valid_LOCHNSEP(fields[69]) == False: return False
        if self.is_valid_LOCHNSUF(fields[70]) == False: return False
        if self.is_valid_LOCHNTYPE(fields[71]) == False: return False
        if self.is_valid_LOCISMAIL(fields[72]) == False: return False
        if self.is_valid_LOCNAME(fields[73]) == False: return False
        if self.is_valid_LOCPLUS4(fields[74]) == False: return False
        if self.is_valid_LOCPREDIR(fields[75]) == False: return False
        if self.is_valid_LOCPREQUAL(fields[76]) == False: return False
        if self.is_valid_LOCPRETYP(fields[77]) == False: return False
        if self.is_valid_LOCSTBLDIND(fields[78]) == False: return False
        if self.is_valid_LOCSTNMSRC(fields[79]) == False: return False
        if self.is_valid_LOCSUFDIR(fields[80]) == False: return False
        if self.is_valid_LOCSUFQUAL(fields[81]) == False: return False
        if self.is_valid_LOCSUFTYP(fields[82]) == False: return False
        if self.is_valid_LOCURB(fields[83]) == False: return False
        if self.is_valid_LOCWSDESC1(fields[84]) == False: return False
        if self.is_valid_LOCWSID1(fields[85]) == False: return False
        if self.is_valid_LOCZIP(fields[86]) == False: return False
        if self.is_valid_LOCZIPCLASS(fields[87]) == False: return False
        if self.is_valid_LUCAAF2020(fields[88]) == False: return False
        if self.is_valid_MAFCSFAIL(fields[89]) == False: return False
        if self.is_valid_MAFID(fields[90]) == False: return False
        if self.is_valid_MAFSRC(fields[91]) == False: return False
        if self.is_valid_MAILAPTCOMPLEX(fields[92]) == False: return False
        if self.is_valid_MAILAREANM1(fields[93]) == False: return False
        if self.is_valid_MAILAREANM2(fields[94]) == False: return False
        if self.is_valid_MAILBLDGDESC(fields[95]) == False: return False
        if self.is_valid_MAILBLDGID(fields[96]) == False: return False
        if self.is_valid_MAILHN1(fields[97]) == False: return False
        if self.is_valid_MAILHN2(fields[98]) == False: return False
        if self.is_valid_MAILHNPR(fields[99]) == False: return False
        if self.is_valid_MAILHNPRE(fields[100]) == False: return False
        if self.is_valid_MAILHNSEP(fields[101]) == False: return False
        if self.is_valid_MAILHNSUF(fields[102]) == False: return False
        if self.is_valid_MAILHNTYPE(fields[103]) == False: return False
        if self.is_valid_MAILNAME(fields[104]) == False: return False
        if self.is_valid_MAILPLUS4(fields[105]) == False: return False
        if self.is_valid_MAILPOBOXID(fields[106]) == False: return False
        if self.is_valid_MAILPREDIR(fields[107]) == False: return False
        if self.is_valid_MAILPREQUAL(fields[108]) == False: return False
        if self.is_valid_MAILPRETYP(fields[109]) == False: return False
        if self.is_valid_MAILRRBOXID(fields[110]) == False: return False
        if self.is_valid_MAILRRDESC(fields[111]) == False: return False
        if self.is_valid_MAILRRID(fields[112]) == False: return False
        if self.is_valid_MAILSTBLDIND(fields[113]) == False: return False
        if self.is_valid_MAILSTNMSRC(fields[114]) == False: return False
        if self.is_valid_MAILSUFDIR(fields[115]) == False: return False
        if self.is_valid_MAILSUFQUAL(fields[116]) == False: return False
        if self.is_valid_MAILSUFTYP(fields[117]) == False: return False
        if self.is_valid_MAILURB(fields[118]) == False: return False
        if self.is_valid_MAILWSDESC1(fields[119]) == False: return False
        if self.is_valid_MAILWSID1(fields[120]) == False: return False
        if self.is_valid_MAILZIP(fields[121]) == False: return False
        if self.is_valid_MAILZIPCLASS(fields[122]) == False: return False
        if self.is_valid_MSPID(fields[123]) == False: return False
        if self.is_valid_MTFCC(fields[124]) == False: return False
        if self.is_valid_NRFUAF(fields[125]) == False: return False
        if self.is_valid_NRFUUNV(fields[126]) == False: return False
        if self.is_valid_NUMUNITS(fields[127]) == False: return False
        if self.is_valid_OFLAT(fields[128]) == False: return False
        if self.is_valid_OFLON(fields[129]) == False: return False
        if self.is_valid_OID(fields[130]) == False: return False
        if self.is_valid_OIDBCU(fields[131]) == False: return False
        if self.is_valid_OIDTB(fields[132]) == False: return False
        if self.is_valid_PDCONVNEW(fields[133]) == False: return False
        if self.is_valid_PDCONVOLD(fields[134]) == False: return False
        if self.is_valid_POPDEC(fields[135]) == False: return False
        if self.is_valid_POPDEC2010(fields[136]) == False: return False
        if self.is_valid_POPDEC2020(fields[137]) == False: return False
        if self.is_valid_POSTPLUS4(fields[138]) == False: return False
        if self.is_valid_POSTZIP(fields[139]) == False: return False
        if self.is_valid_POSTZIPCLASS(fields[140]) == False: return False
        if self.is_valid_RAMAL(fields[141]) == False: return False
        if self.is_valid_RESSTAT(fields[142]) == False: return False
        if self.is_valid_SECCION(fields[143]) == False: return False
        if self.is_valid_SIDE(fields[144]) == False: return False
        if self.is_valid_SUPNRFUAF(fields[145]) == False: return False
        if self.is_valid_SUPNRFUUNV(fields[146]) == False: return False
        if self.is_valid_SURVMAFID(fields[147]) == False: return False
        if self.is_valid_TAB2010BLK(fields[148]) == False: return False
        if self.is_valid_TAB2010BLKCOU(fields[149]) == False: return False
        if self.is_valid_TAB2010BLKST(fields[150]) == False: return False
        if self.is_valid_TAB2010BLKSUFX1(fields[151]) == False: return False
        if self.is_valid_TAB2010BLKSUFX2(fields[152]) == False: return False
        if self.is_valid_TAB2010BLKTRACT(fields[153]) == False: return False
        if self.is_valid_TAB2020BLK(fields[154]) == False: return False
        if self.is_valid_TAB2020BLKCOU(fields[155]) == False: return False
        if self.is_valid_TAB2020BLKST(fields[156]) == False: return False
        if self.is_valid_TAB2020BLKSUFX1(fields[157]) == False: return False
        if self.is_valid_TAB2020BLKSUFX2(fields[158]) == False: return False
        if self.is_valid_TAB2020BLKTRACT(fields[159]) == False: return False
        if self.is_valid_TABAF(fields[160]) == False: return False
        if self.is_valid_TABMS(fields[161]) == False: return False
        if self.is_valid_TEA(fields[162]) == False: return False
        if self.is_valid_TLID(fields[163]) == False: return False
        if self.is_valid_UNITSTAT(fields[164]) == False: return False
        if self.is_valid_WSDESC2PR(fields[165]) == False: return False
        if self.is_valid_WSID2PR(fields[166]) == False: return False
        if self.is_valid_XTYP(fields[167]) == False: return False
        return True
...
class I_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_OIDBCU(fields[1]) == False: return False
        if self.is_valid_STATEFP(fields[2]) == False: return False
        if self.is_valid_COUNTYFP(fields[3]) == False: return False
        if self.is_valid_TRACTCE(fields[4]) == False: return False
        if self.is_valid_BCUID(fields[5]) == False: return False
        if self.is_valid_LWBCUTYP(fields[6]) == False: return False
        if self.is_valid_RCCCE(fields[7]) == False: return False
        if self.is_valid_ACOCE(fields[8]) == False: return False
        if self.is_valid_CFMCE(fields[9]) == False: return False
        if self.is_valid_CFSCE(fields[10]) == False: return False
        if self.is_valid_FLDOPCODE(fields[11]) == False: return False
        if self.is_valid_OPCODE(fields[12]) == False: return False
        if self.is_valid_TEA(fields[13]) == False: return False
        if self.is_valid_AIANNHCE(fields[14]) == False: return False
        if self.is_valid_MILITARYANSI(fields[15]) == False: return False
        if self.is_valid_INTPTLON(fields[16]) == False: return False
        if self.is_valid_INTPTLAT(fields[17]) == False: return False
        if self.is_valid_AREALAND(fields[18]) == False: return False
        if self.is_valid_AREAWATER(fields[19]) == False: return False
        if self.is_valid_HOUSING(fields[20]) == False: return False
        if self.is_valid_ADCNFLG(fields[21]) == False: return False
        if self.is_valid_VINTAGE(fields[22]) == False: return False
        if self.is_valid_ISINSITE(fields[23]) == False: return False
        if self.is_valid_ADCNACOCE(fields[24]) == False: return False
        return True
...
class G_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_OID(fields[1]) == False: return False
        if self.is_valid_STATEFP(fields[2]) == False: return False
        if self.is_valid_COUNTYFP(fields[3]) == False: return False
        if self.is_valid_TRACTCE(fields[4]) == False: return False
        if self.is_valid_RCCCE(fields[5]) == False: return False
        if self.is_valid_ACOCE(fields[6]) == False: return False
        if self.is_valid_CFMCE(fields[7]) == False: return False
        if self.is_valid_CFSCE(fields[8]) == False: return False
        ...
        if self.is_valid_INTPTLON(fields[12]) == False: return False
        if self.is_valid_INTPTLAT(fields[13]) == False: return False
        if self.is_valid_CENTLON(fields[14]) == False: return False
        if self.is_valid_CENTLAT(fields[15]) == False: return False
        if self.is_valid_AREALAND(fields[16]) == False: return False
        if self.is_valid_AREAWATER(fields[17]) == False: return False
        if self.is_valid_HOUSING(fields[18]) == False: return False
        if self.is_valid_MTFCC(fields[19]) == False: return False
        return True
...
class GRFC20_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_TABBLKST(fields[1]) == False: return False
        if self.is_valid_TABBLKCOU(fields[2]) == False: return False
        if self.is_valid_TABTRACTCE(fields[3]) == False: return False
        if self.is_valid_TABBLK(fields[4]) == False: return False
        if self.is_valid_TABBLKSUFX1(fields[5]) == False: return False
        if self.is_valid_TABBLKSUFX2(fields[6]) == False: return False
        if self.is_valid_TABBLKGRPCE(fields[7]) == False: return False
        if self.is_valid_POPDEC(fields[8]) == False: return False
        if self.is_valid_HOUSING(fields[9]) == False: return False
        if self.is_valid_CURSTATE(fields[10]) == False: return False
        if self.is_valid_CURCOUNTY(fields[11]) == False: return False
        if self.is_valid_CURTRACTCE(fields[12]) == False: return False
        if self.is_valid_CURBLKGRPCE(fields[13]) == False: return False
        if self.is_valid_REGIONCE(fields[14]) == False: return False
        if self.is_valid_DIVISIONCE(fields[15]) == False: return False
        if self.is_valid_STATENS(fields[16]) == False: return False
        if self.is_valid_COUNTYNS(fields[17]) == False: return False
        if self.is_valid_COUNTYFS(fields[18]) == False: return False
        if self.is_valid_COUSUBFP(fields[19]) == False: return False
        if self.is_valid_COUSUBNS(fields[20]) == False: return False
        if self.is_valid_COUSUBFS(fields[21]) == False: return False
        if self.is_valid_SUBMCDFP(fields[22]) == False: return False
        if self.is_valid_SUBMCDNS(fields[23]) == False: return False
        if self.is_valid_ESTATEFP(fields[24]) == False: return False
        if self.is_valid_ESTATENS(fields[25]) == False: return False
        if self.is_valid_CONCITFP(fields[26]) == False: return False
        if self.is_valid_CONCITNS(fields[27]) == False: return False
        if self.is_valid_PLACEFP(fields[28]) == False: return False
        if self.is_valid_PLACENS(fields[29]) == False: return False
        if self.is_valid_PLACEFS(fields[30]) == False: return False
        if self.is_valid_AIANNHFP(fields[31]) == False: return False
        if self.is_valid_AIANNHCE(fields[32]) == False: return False
        if self.is_valid_AIANNHNS(fields[33]) == False: return False
        if self.is_valid_AIHHTLI(fields[34]) == False: return False
        if self.is_valid_TRIBALSUBFP(fields[35]) == False: return False
        if self.is_valid_TRIBALSUBCE(fields[36]) == False: return False
        if self.is_valid_TRIBALSUBNS(fields[37]) == False: return False
        if self.is_valid_TTRACTCE(fields[38]) == False: return False
        if self.is_valid_TBLKGRPCE(fields[39]) == False: return False
        if self.is_valid_ANRCFP(fields[40]) == False: return False
        if self.is_valid_ANRCNS(fields[41]) == False: return False
        if self.is_valid_UACE(fields[42]) == False: return False
        if self.is_valid_UATYP(fields[43]) == False: return False
        if self.is_valid_UR(fields[44]) == False: return False
        if self.is_valid_CD116FP(fields[45]) == False: return False
        if self.is_valid_CDCURFP(fields[46]) == False: return False
        if self.is_valid_VTDST(fields[47]) == False: return False
        if self.is_valid_SLDUST(fields[48]) == False: return False
        if self.is_valid_SLDLST(fields[49]) == False: return False
        if self.is_valid_ZCTA5CE(fields[50]) == False: return False
        if self.is_valid_SDELMLEA(fields[51]) == False: return False
        if self.is_valid_SDSECLEA(fields[52]) == False: return False
        if self.is_valid_SDUNILEA(fields[53]) == False: return False
        if self.is_valid_UGACE(fields[54]) == False: return False
        if self.is_valid_PUMA(fields[55]) == False: return False
        if self.is_valid_LWBLKTYP(fields[56]) == False: return False
        if self.is_valid_INTPTLAT(fields[57]) == False: return False
        if self.is_valid_INTPTLON(fields[58]) == False: return False
        if self.is_valid_AREALAND(fields[59]) == False: return False
        if self.is_valid_AREAWATER(fields[60]) == False: return False
        if self.is_valid_AREAWATERINLD(fields[61]) == False: return False
        if self.is_valid_AREAWATERCSTL(fields[62]) == False: return False
        if self.is_valid_AREAWATERGRLK(fields[63]) == False: return False
        if self.is_valid_AREAWATERTSEA(fields[64]) == False: return False
        if self.is_valid_CSAFP(fields[65]) == False: return False
        if self.is_valid_CBSAFP(fields[66]) == False: return False
        if self.is_valid_METDIVFP(fields[67]) == False: return False
        if self.is_valid_PCICBSA(fields[68]) == False: return False
        if self.is_valid_CNECTAFP(fields[69]) == False: return False
        if self.is_valid_NECTAFP(fields[70]) == False: return False
        if self.is_valid_NECTADIVFP(fields[71]) == False: return False
        if self.is_valid_PCINECTA(fields[72]) == False: return False
        if self.is_valid_ACT(fields[73]) == False: return False
        if self.is_valid_MEMI(fields[74]) == False: return False
        if self.is_valid_NMEMI(fields[75]) == False: return False
        if self.is_valid_OIDTABBLK(fields[76]) == False: return False
        return True
...
class L_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_MTFCC(fields[1]) == False: return False
        if self.is_valid_VINTAGE(fields[2]) == False: return False
        if self.is_valid_STATEFP(fields[3]) == False: return False
        if self.is_valid_COUNTYFP(fields[4]) == False: return False
        if self.is_valid_GEOCE(fields[5]) == False: return False
        if self.is_valid_GEOFP(fields[6]) == False: return False
        if self.is_valid_GEONS(fields[7]) == False: return False
        if self.is_valid_PARENT(fields[8]) == False: return False
        if self.is_valid_PARENT2(fields[9]) == False: return False
        if self.is_valid_NAME(fields[10]) == False: return False
        if self.is_valid_NAMELSAD(fields[11]) == False: return False
        if self.is_valid_FUNCSTAT(fields[12]) == False: return False
        if self.is_valid_LSADC(fields[13]) == False: return False
        if self.is_valid_PARTFLAG(fields[14]) == False: return False
        if self.is_valid_AIANNHFSR(fields[15]) == False: return False
        if self.is_valid_AIANNHTYP(fields[16]) == False: return False
        if self.is_valid_CLASSFP(fields[17]) == False: return False
        if self.is_valid_STATEUSPS(fields[18]) == False: return False
        if self.is_valid_MEMI(fields[19]) == False: return False
        if self.is_valid_PCICBSA(fields[20]) == False: return False
        if self.is_valid_PCINECTA(fields[21]) == False: return False
        if self.is_valid_CPI(fields[22]) == False: return False
        if self.is_valid_CDSESSN(fields[23]) == False: return False
        if self.is_valid_LSY(fields[24]) == False: return False
        if self.is_valid_VTDI(fields[25]) == False: return False
        if self.is_valid_UR(fields[26]) == False: return False
        if self.is_valid_UATYPE(fields[27]) == False: return False
        if self.is_valid_GCUNI(fields[28]) == False: return False
        if self.is_valid_CENTLAT(fields[29]) == False: return False
        if self.is_valid_CENTLON(fields[30]) == False: return False
        if self.is_valid_INTPTLAT(fields[31]) == False: return False
        if self.is_valid_INTPTLON(fields[32]) == False: return False
        if self.is_valid_AREALAND(fields[33]) == False: return False
        if self.is_valid_AREAWATER(fields[34]) == False: return False
        if self.is_valid_OID(fields[35]) == False: return False
        return True
...
class O_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_ACTION(fields[2]) == False: return False
        if self.is_valid_UNITSTAT(fields[3]) == False: return False
        if self.is_valid_GQHUFLAG(fields[4]) == False: return False
        if self.is_valid_REJECT(fields[5]) == False: return False
        if self.is_valid_MAFSRC(fields[6]) == False: return False
        return True
...
class P_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_MAFID(fields[1]) == False: return False
        if self.is_valid_STATE(fields[2]) == False: return False
        if self.is_valid_COUNTY(fields[3]) == False: return False
        if self.is_valid_TRACT(fields[4]) == False: return False
        if self.is_valid_COUSUB(fields[5]) == False: return False
        if self.is_valid_PLACE(fields[6]) == False: return False
        if self.is_valid_CONCITY(fields[7]) == False: return False
        if self.is_valid_AIANNH(fields[8]) == False: return False
        if self.is_valid_TRIBALCT(fields[9]) == False: return False
        if self.is_valid_CD(fields[10]) == False: return False
        if self.is_valid_REGION(fields[11]) == False: return False
        if self.is_valid_ACO(fields[12]) == False: return False
        return True
