...
DAS_DIR = '/mnt/users/blalo306/das_decennial'
sys.path.append('/mnt/users/blalo306/das_decennial')
#sys.path.append(os.path.join(os.path.dirname(__file__), ".."))

#DAS_DIR    = os.path.dirname( os.path.abspath( __file__ ))
#sys.path.append(os.path.join(os.path.dirname(__file__), ".."))

#os.environ["PYTHONPATH"] = "/mnt/users/blalo306/das_decennial"
import numpy as np
...
if __name__=="__main__":
    ...
    table_data.to_csv('/mnt/users/blalo306/dhcp_tables.csv')
    ...
    table_data=pd.concat(table_data)
    table_data.to_csv('/mnt/users/blalo306/dhch_tables.csv')
'''
...
das_utils.ship_files2spark(spark,tempdir='/mnt/users/blalo306/')
...
#path="s3://uscb-decennial-ite-das/experiments/convertedFromGeounitNodeToDict/PL94_SF1_c1state3/td001_1/run_0/data/"
...
accuracy_saveloc = f"/mnt/users/blalo306/testing.csv"
...
experiment="s3://uscb-decennial-ite-das/experiments/convertedFromGeounitNodeToDict/PL94_SF1_c1state/td10_1/"
...
das_utils.ship_files2spark(spark,subdirs=('programs','das_framework','analysis'),tempdir='/mnt/users/blalo306/')
