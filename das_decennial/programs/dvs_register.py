...
s3://uscb-decennial-ite-das/users/garfi303/topdown_RI/noisy_measurements/application_1607440845980_0017-TractOptimized.pickle/part-00937
s3://uscb-decennial-ite-das/users/garfi303/topdown_RI/data/part-00985
...
def dvs_dc_populate(dc, logfile, ephemeral=False):
    ...
    for (key, vals) in extract_paths(logfile).items():
        ...
        for git_info in [val for val in vals if not val.startswith("s3://") ]:
            ...
            url='https://github.ti.census.gov/CB-DAS/'+words[0]
