...
class TestNaNReturns:
    ...
    def test_dp_nan(self, mechclass, query):
    ...
    def test_wrong_budget_type(self, mechclass, query):
    ...
    def test_mechanism_wrong_type(self, shape, inv_scale_value):
...
def test_computeDiscreteGaussianVariance(sigma_sq):
