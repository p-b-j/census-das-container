# Example: spark-submit lecle_checkStateTotal_and_GQHH_Invariants.py
...
#persons_csv_mdf_s3_path = "s3://uscb-decennial-ite-das/users/lecle301/DemonstrationProducts_Sept2019_fixedTotals_BAK2/full_person_unpickled/td4/run_0000/persons.csv"
persons_csv_mdf_s3_path = "s3://uscb-decennial-ite-das/users/lecle301/cnstatDdpSchema_DataIndUserSpecifiedQueriesNPass_National_dpQueries1_officialCNSTATrun/data-run1.0-epsilon4.0-DHCP_MDF.txt"
...
def getCEFUnitsDF(spark):
    if TEST:
        df = spark.read.csv("s3://uscb-decennial-ite-das/title13_input_data/table10/ri44.txt", header=True, sep='\\t')
    else:
