...
def getCategoryByAgeQuantiles(sdf, geolevels, queries):
...
def getGeolevelSparsity(sdf, geolevels, queries):
    sdf = sdf.getGeolevels(geolevels)
    sdf = sdf.answerQueries(queries)
    df = sdf.df
    schema = sdf.schema
...
if __name__ == "__main__":
    ...
    experimentDesignators = list(experiments.keys())
