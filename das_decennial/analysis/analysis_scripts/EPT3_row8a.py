# This script implements plots for row #8, 2 or more races in Exec Tab #3
   ...
   #     "P2": [
    ...
    for table_name, queries in tabledict.items():
        ...
        sns.violinplot(x=x_axis_variable_name, y=metric_name, data=pandas_df, order=bucketNames,
                                    ...
                                    .set_title(f"Average L1 Error (over trials) for 2 or more races, age (0 to 85, and 85+), sex, and hispanic at state geolevel")
