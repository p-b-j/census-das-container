...
#         "Table 3"               :   (["total"], "A", '0', '0', '0')
         "Table 5"               : ([""],"F","","",""),
#          "Table 5b"               : (["hispanic*whiteAlone"], "A", '0','0','0')
...
geolevels_dict["Table 5"]        = [C.COUNTY]
geolevels_dict["Table 5b"]        = [C.COUNTY]
...
def MattsMetrics(query, table_name, analysis, spark, geolevels, key, agekey, sexkey, bucketkey, schema="DHCP_HHGQ"):
    ...
    # This finds overall metrics
        ...
        metrics_result = sdftools.combined_metrics(schema, spark_df, spark, geolevels, agekey, sexkey, bucketkey, key)
