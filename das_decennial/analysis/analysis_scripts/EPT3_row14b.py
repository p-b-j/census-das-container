# This script implements plots for row 14, 6 races for age 0-17/17+, County Level in Exec Tab #3
    ...
    for table_name, queries in tabledict.items():
        ...
        for k in races_names:
             ...
             sns.violinplot(x=x_axis_variable_name, y=metric_name, data=bel, order=bucketNames,
                                    ...
                                    .set_title(f"Average L1 Error (over trials) for race {k} for County Level for hispanic, ages 0 to 17 and 17+\n(binned by CEF count)")
