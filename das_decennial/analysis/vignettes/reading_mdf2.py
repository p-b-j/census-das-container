...
if __name__ == "__main__":
    ...
    mdf = "s3://uscb-decennial-ite-das/users/heiss002/cnstatDdpSchema_DataIndUserSpecifiedQueriesNPass_va_dpQueries5_version7/data-run1.0-epsilon4.0-DHCP_MDF.txt"
...
#    df.RTYPE.unique()
 #   df.GQTYPE.unique()
    ...
    df=df.withColumnRenamed("count","priv")
    df.show(1000)
