...
class MDF2HistDF_DHCP_HHGQ():
    ...
    def _recode_sex(self, df):
        ...
        if self.debugmode: sdftools.show(df, "Priv DF with sex recode")
        return df
    ...
    def _recode_age(self, df):
        ...
        if self.debugmode: sdftools.show(df, "Priv DF with age recode")
        return df
    ...
    def _recode_hispanic(self, df):
        ...
        if self.debugmode: sdftools.show(df, "Priv DF with hispanic recode")
        return df
    ...
    def _recode_cenrace(self, df):
        ...
        if self.debugmode: sdftools.show(df, "Priv DF with cenrace recode")
        return df
    ...
    def _recode_citizen(self, df):
        ...
        if self.debugmode: sdftools.show(df, "Priv DF with citizen recode")
        return df
...
if __name__ == "__main__":
    ...
    #mdf_path = "s3://uscb-decennial-ite-das/users/heiss002/cnstatDdpSchema_DataIndUserSpecifiedQueriesNPass_va_dpQueries5_version7/data-run1.0-epsilon4.0-DHCP_MDF.txt"
