...
[[ -v SPARK_RESOURCES ]] ||
  SPARK_RESOURCES="--driver-memory 5g --num-executors 18 --executor-memory 200g --executor-cores 24 --driver-cores 10 --conf spark.dynamicAllocation.maxExecutors=20 --conf spark.driver.maxResultSize=0g --conf spark.executor.memoryOverhead=200g"
