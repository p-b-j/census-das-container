...
@pytest.mark.parametrize(
    ...
    [
        (os.path.expandvars("$DAS_S3ROOT/unit-test-data/test_cef_recode_pipeline/cenrace_cef.data"),
         os.path.expandvars("$DAS_S3ROOT/unit-test-data/test_cef_recode_pipeline/cenrace_mdf.data"), DHC_MDF_Person,
        ...
        (os.path.expandvars("$DAS_S3ROOT/unit-test-data/test_cef_recode_pipeline/hhtype_cef.data"),
         os.path.expandvars("$DAS_S3ROOT/unit-test-data/test_cef_recode_pipeline/hhtype_mdf.data"), DHC_MDF_Unit,
         DHCH_Household_recoder, {"hhsex_varname_list": ("hhsex",), "hhage_varname_list": ("hhldrage",),
                                  ...
                                  "tenshort_varname_list": ("ten",), "hht_varname_list": ("hht",)},
