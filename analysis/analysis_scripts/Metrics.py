...
table_default_bucket_list2 = ['Table 11', 'Table 12', 'Table 15a', 'Table 15b', 'Table 15c', 'Table 15d', 'Table 15e', 'Table 15f', 'Table 15g','Table 16a', 'Table 16b', 'Table 16c', 'Table 16d', 'Table 16e', 'Table 16f', 'Table 16g','Table 19a','Table 19b','Table 19c','Table 19d','Table 19e','Table 19f','Table 20a','Table 20b','Table 20c','Table 20d','Table 20e','Table 20f','Table 23a','Table 23b','Table 23c','Table 23d','Table 23e','Table 23f','Table 24a','Table 24b','Table 24c','Table 24d','Table 24e','Table 24f']



table_race_query = ['Table 17a', 'Table 17b', 'Table 17c', 'Table 17d', 'Table 17e', 'Table 17f', 'Table 17g', 'Table 18a', 'Table 18b', 'Table 18c', 'Table 18d', 'Table 18e', 'Table 18f','Table 19a','Table 19b','Table 19c','Table 19d','Table 19e','Table 19f','Table 20a','Table 20b','Table 20c','Table 20d','Table 20e','Table 20f', 'Table 21a', '\
Table 21b', 'Table 21c', 'Table 21d', 'Table 21e', 'Table 21f', 'Table 23a','Table 23b','Table 23c','Table 23d','Table 23e','Table 23f']
table_default_no_bucket = ['Table 3', 'Table 10', 'Table 14a', 'Table 14b', 'Table 14c', 'Table 14d', 'Table 14e', 'Table 14f', 'Table 14g','Table 15a', 'Table 15b', 'Table 15c', 'Table 15d', 'Table 15e', 'Table 15f', 'Table 15g','Table 16a', 'Table 16b', 'Table 16c', 'Table 16d', 'Table 16e', 'Table 16f', 'Table 16g','Table 17a', 'Table 17b', 'Table 17c', 'Table 17d', 'Table 17e', 'Table 17f', 'Table 17g', 'Table 18a', 'Table 18b', 'Table 18c', 'Table 18d', 'Table 18e', 'Table 18f','Table 21a', 'Table 21b', 'Table 21c', 'Table 21d', 'Table 21e', 'Table 21f', 'Table 22a','Table 22b', 'Table 22c', 'Table 22d', 'Table 22e', 'Table 22f', 'Table 25a','Table 25b', 'Table 25c', 'Table 25d', 'Table 25e', 'Table 25f', 'Table 26a','Table 26b', 'Table 26c', 'Table 26d', 'Table 26e', 'Table 26f','Table 27a', 'Table 27b','Table 27c','Table 27d','Table 27e', 'Table 27f', 'Table 27g','Table 28a', 'Table 28b', 'Table 28c', 'Table 28d', 'Table 28e', 'Table 28f', 'Table 29a', 'Table 29b','Table 29c','Table 29d','Table 29e','Table 29f', 'Table 30a','Table 30b', 'Table 30c', 'Table 30d', 'Table 30e', 'Table 30f', 'Table 31a','Table 31b', 'Table 31c', 'Table 31d', 'Table 31e', 'Table 31f',]
    ...
    for g in geolevels:
        ...
        if table_name in table_default_no_bucket: # If data is not in buckets
            if table_name in table_race_query:  # Table 17, 18, 21 and others
                ...
                spark_df2 = spark_df1.subtract(spark_df1.filter(spark_df1.level.rlike("Not")))
        ...
        if table_name in table_age_bracket1:
            ...
            for age_range in age_range_list:
                subset_sparkdf1 = spark_df1.filter(spark_df1.level.rlike(age_range))
                subset_sparkdf1.show(100, False)
                metrics_dataframe = sdftools.mattsmetrics(subset_sparkdf1,spark)
                #subset_sparkdf1.show(100, False)
        ...
        if table_name in table_age_bracket2:
            ...
            for sexlevel in sex_range_list:
                subset_sparkdf1 = spark_df1.filter(spark_df1.level.rlike(sexlevel))
                for age_range in age_range_list:
                    subset_sparkdf2 = subset_sparkdf1.filter(subset_sparkdf1.level.rlike(age_range))
                    subset_sparkdf2.show(100, False)
                    metrics_dataframe = sdftools.mattsmetrics(subset_sparkdf2,spark)
                #subset_sparkdf1.show(100, False)
        ...
        if table_name in table_default_bucket_list2: # If data is in buckets [0,10],[10,100),[100+)
            ...
            for b in default_buckets2: # calculate Metrics at each bucket
                print("Bucket is:" , b)
                subset_sparkdf =spark_df1[spark_df1['orig_count_bin']==b] #subset into bins
