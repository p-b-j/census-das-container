# This script implements plots for row 8, 6 races, in Exec Tab #3
    ...
    for table_name, queries in tabledict.items():
        ...
        for k in races_names:
             ...
             sns.violinplot(x=x_axis_variable_name, y=metric_name, data=bel, order=bucketNames,
                                    ...
                                    .set_title(f"Average L1 Error (over trials) for race {k} at state geolevel for ages 0 to 85 and 85+\n(binned by CEF count)")
