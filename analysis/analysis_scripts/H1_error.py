...
paths = ['s3://uscb-decennial-ite-das/runs/tests/DSEP-DEC2020-H1-strategy1a-MultipassRounder-opt_spine-scale12800-dynamic_geolevel-20210221-135839/mdf/us/unit/MDF10_UNIT_US.txt/MDF10_UNIT_US-BlockNodeDicts/']
"""
...
run_ids = []
for path in paths:
    run_id_str = path.split("tests/DSEP-DEC2020-")[1]
    run_id = ""
