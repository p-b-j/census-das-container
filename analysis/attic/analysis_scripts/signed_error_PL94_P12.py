...
if __name__ == "__main__":
    ...
    # queries = ['detailed', 'total', 'hhgq', 'votingage', 'numraces * hispanic', 'cenrace * hispanic', 'sex * agecat']
    queries = ['detailed']
    ...
    for d in experimentDesignators:
        ...
        experimentName = f"analyses/{experimentDesignator}_{numTrials}Trial_allPLBs"
        ...
        mb.add(
            ...
            metric_function = lambda sdf: sdftools.getSignedErrorByTrueCountRuns(sdf.getGeolevels(geolevels).answerQueries(queries).df)
        )
